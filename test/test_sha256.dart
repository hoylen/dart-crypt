...
//----------------------------------------------------------------
  ...
  group("SHA256", () {
    ...
    test("examples from the specification", () {
      expect(Util_Crypt.sha256("Hello world!", salt: "saltstring"),
          equals(r"$5$saltstring$5B8vYYiY.CVt1RlTTf8KbXBH3hsxY/GNooZaBBGWEc5"));

      expect(Util_Crypt.sha256("Hello world!",
    ...
    test("examples from PHP crypt documentation", () {
      expect(Util_Crypt.sha256("rasmuslerdorf",
    ...
    skip_test("timing", () async {
      ...
      var hash = Util_Crypt.sha256("p@ssw0rd",
